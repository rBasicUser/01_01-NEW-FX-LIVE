...
p_top <- ggplot(data_60m, aes(x = Fecha)) +
  ...
  geom_line(aes(y = SMA200), color = "#920000", linewidth = 0.9, alpha = 0.9) +
  labs(
...
p_bottom <- ggplot(data_24m, aes(x = Fecha)) +
  ...
  geom_ribbon(aes(ymin = Lower20, ymax = Higher20), alpha = 0.15, fill = "#f40000") +
  geom_ribbon(aes(ymin = Lower50, ymax = Higher50), alpha = 0.10, fill = "#ff5757") +
  geom_line(aes(y = SMA50), color = "#f40000", linewidth = 0.9) +
  geom_line(aes(y = SMA20), color = "#ff5757", linewidth = 0.9) +
  labs(
