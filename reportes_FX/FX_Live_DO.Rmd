...
p_bottom <- ggplot(data_24m, aes(x = Fecha)) +
  ...
  geom_ribbon(aes(ymin = Lower20, ymax = Higher20), alpha = 0.15, fill = "#a0dd51") +
  geom_ribbon(aes(ymin = Lower50, ymax = Higher50), alpha = 0.10, fill = "#75b523") +
  geom_line(aes(y = SMA50), color = "#a0dd51", linewidth = 0.9) +
  geom_line(aes(y = SMA20), color = "#75b523", linewidth = 0.9) +
  labs(
