...
p_top <- ggplot(data_60m, aes(x = Fecha)) +
  ...
  geom_line(aes(y = SMA200), color = "#00223a", linewidth = 0.9, alpha = 0.9) +
  labs(
...
p_bottom <- ggplot(data_24m, aes(x = Fecha)) +
  ...
  geom_ribbon(aes(ymin = Lower20, ymax = Higher20), alpha = 0.15, fill = "#005388") +
  geom_ribbon(aes(ymin = Lower50, ymax = Higher50), alpha = 0.10, fill = "#003b61") +
  geom_line(aes(y = SMA50), color = "#005388", linewidth = 0.9) +
  geom_line(aes(y = SMA20), color = "#003b61", linewidth = 0.9) +
  labs(
