...
p_top <- ggplot(data_60m, aes(x = Fecha)) +
  ...
  geom_line(aes(y = SMA200), color = "#466d15", linewidth = 0.9, alpha = 0.9) +
  labs(
...
p_bottom <- ggplot(data_24m, aes(x = Fecha)) +
  ...
  geom_ribbon(aes(ymin = Lower20, ymax = Higher20), alpha = 0.15, fill = "#537f19") +
  geom_ribbon(aes(ymin = Lower50, ymax = Higher50), alpha = 0.10, fill = "#3b5b12") +
  geom_line(aes(y = SMA50), color = "#537f19", linewidth = 0.9) +
  geom_line(aes(y = SMA20), color = "#3b5b12", linewidth = 0.9) +
  labs(
